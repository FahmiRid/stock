    ...
    <section class="sidebar">
      ...
      <!--                        <li class="treeview" id="mainUserNav">
           ...
           --> --> // USER AND GROUP
                      ...
                      <li id="brandNav">
              <a href="http://localhost/stock/demo/bran.php">
                <i class="glyphicon glyphicon-tags"></i> <span>Brands</span>
              </a>
            </li>
          
                      <li id="categoryNav">
              <a href="http://localhost/stock/demo/cater.php">
...
<div class="modal fade" tabindex="-1" role="dialog" id="addModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form role="form" action="http://localhost:/stock/attributes/create" method="post" id="createForm">
...
<div class="modal fade" tabindex="-1" role="dialog" id="editModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form role="form" action="http://localhost:/stock/attributes/update" method="post" id="updateForm">
...
<div class="modal fade" tabindex="-1" role="dialog" id="removeModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form role="form" action="http://localhost:/stock/attributes/remove" method="post" id="removeForm">
        <div class="modal-body">
...
function removeFunc(id)
{
  ...
  <footer class="main-footer">
    ...
    <strong>Original &copy; 2020-2020.</strong> Own by WUFO. 
  </footer>

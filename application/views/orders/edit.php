          ...
          <form role="form" action="<?php base_url('orders/create') ?>" method="post" class="form-horizontal">
              <div class="box-body">
                ...
                <div class="col-md-6 col-xs-12 pull pull-right">
                  ...
                  <div class="form-group">
                    <label for="service_charge" class="col-sm-5 control-label">Retail Charge <?php echo $company_data['service_charge_value'] ?> %</label>
                    <div class="col-sm-7">
                  ...
                  <div class="form-group">
                    <label for="vat_charge" class="col-sm-5 control-label">SST <?php echo $company_data['vat_charge_value'] ?> %</label>
                    <div class="col-sm-7">
